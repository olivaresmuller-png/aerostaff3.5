...
export function Layout({ children, employees, assignments, onImport, onReset }: LayoutProps) {
  ...
  const handleExport = () => {
    if (employees && assignments) {
      downloadExport(employees, assignments);
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
        <div className="p-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display font-bold text-lg tracking-tight">TMBA</h1>
